...
from EshartApp.api.views import travelRespond_api,travelDetail_api,passengerConfirmation_api,ticketRegistration_api,supporter_api,adminLogin_api
urlpatterns = [
    ...
    path("adminLogin_api/",adminLogin_api.as_view(),name="adminLogin_api"),
